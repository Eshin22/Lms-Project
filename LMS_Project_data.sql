-- User Table
USE lms_project;
INSERT INTO `User` (`User_Name`, `Role`, `Passward`)
VALUES ('admin01', 'Admin', 'admin123'),
...
VALUES ('F01', 'Engineering', 'Building A'),
...
VALUES (
    ...
    (
        ...
        '789123456V',
        'C04',
        'https://plus.unsplash.com/premium_photo-1710846906747-7ee7199956ed?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTN8fHNhbXBsZXxlbnwwfHwwfHx8MA%3D%3D'
    ),
    (
        'T05',
        'Lecturer',
        ...
        '654987321V',
        'C05',
        'https://images.unsplash.com/photo-1579165466741-7f35e4755660?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8c2FtcGxlfGVufDB8fDB8fHww'
    );
-- Student Table
INSERT INTO `Student` (
        `Student_ID`,
...
VALUES (
    ...
    (
        ...
        '789654321V',
        'C05',
        'https://example.com/images/eve.jpg'
    );
-- Admin Table
INSERT INTO `Admin` (
        `Admin_ID`,
...
INSERT INTO `Module_Enrollment` (
        `Module_Enrollment_ID`,
        `Student_ID`,
        `Module_ID`,
        `Enrollment_Date`
    )
VALUES (1, 'S01', 'M01', '2024-02-01'),
...
VALUES (
    ...
    (
        ...
        'Video',
        'http://example.com/thermo_basics.mp4',
        '2024-03-02',
        'public',
        'M02',
        'T02'
    ...
    (
        ...
        'Assignment',
        'http://example.com/accounting_assignment.pdf',
        '2024-03-03',
        'private',
        'M03',
        'T03'
    ...
    (
        ...
        'Quiz',
        'http://example.com/quantum_quiz.html',
        '2024-03-04',
        'public',
        'M04',
        'T04'
...
VALUES (
    ...
    (
        ...
        '2024-03-11 13:00:00',
        '01:00:00',
        'Advanced Quantum Mechanics Quiz'
    ),
    (
        3,
        4,
...
-- Forum Table
INSERT INTO `Forum` (`Forum_ID`, `Content_ID`)
VALUES (1, 5),
    (2, 5),
    (3, 5),
    (4, 5),
...
-- Grades Table
INSERT INTO `Grades` (`Module_ID`, `Student_ID`, `Grade`)
VALUES ('M01', 'S01', 'A'),
    ('M02', 'S02', 'B+'),
    ('M03', 'S03', 'A-'),
    ('M04', 'S04', 'B'),
...
VALUES (1, '2024-04-01 10:00:00', 'S01', 'Quiz', 'M01'),
    (
        2,
        '2024-04-02 11:00:00',
        'S02',
...
VALUES (1, 1, 95.00, 'Excellent work.', '00:55:00'),
...
VALUES (2, 1, 88.00, 'Good effort.', '03:00:00'),
...
INSERT INTO `Forum_Submission` (`Submission_ID`, `Forum_ID`, `Description`)
VALUES (3, 1, 'Discussed key points in the lecture.'),
